...
const { listDomain } = require("./listdomain")
...
const getVideo = async (url, watermark) => {
    ...
    for (domain of listDomain) {
        console.log('domain:', domain)
        try {
            const API_URL = `https://${domain}/aweme/v1/feed/?aweme_id=${idVideo}&iid=7318518857994389254&device_id=7318517321748022790&channel=googleplay&app_name=musical_ly&version_code=300904&device_platform=android&device_type=ASUS_Z01QD&version=9`;
    ...
    //  Nadiaskhar
    // const API_URL = `https://www.tikwm.com/video/media/play/${idVideo}.mp4`;
    ...
    // const API_URL = `https://api21-core-n-useast1a.tiktokv.com/aweme/v1/feed/?aweme_id=${idVideo}&iid=7318518857994389254&device_id=7318517321748022790&channel=googleplay&app_name=musical_ly&version_code=300904&device_platform=android&device_type=ASUS_Z01QD&version=9`;
    // const request = await fetch(API_URL, {
    //     method: "OPTIONS",
    //     headers: headers,
    // });
...
const getListVideoByUsername = async (username) => {
    ...
    writeArrayToFile('list.txt', listVideo);
    return listVideo;
};
